...
public class CodeTextField: UIControl {
   ...
   public var font: UIFont = UIFont.systemFont(ofSize: 18.0)  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitCornerRadius: CGFloat = 12.0  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBackgroundColor: UIColor = UIColor.white  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBackgroundColorFocused: UIColor = UIColor.clear  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBackgroundColorEmpty: UIColor = UIColor.white  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBorderColor: UIColor = UIColor.wGray  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBorderColorFocused: UIColor = UIColor.wBlue_49B  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBorderColorEmpty: UIColor = UIColor.wGray  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitBorderWidth: CGFloat = 2.0  {
        didSet {
            refreshUI()
        }
    }
    
   public var digitSpacing: CGFloat = 5.0  {
        didSet {
            refreshUI()
        }
    }
   ...
   public var textColorFocused: UIColor = UIColor.black  {
        didSet {
            refreshUI()
        }
    }
   ...
   public var secureTextEntryMaskCharacter: String = "*" {
        didSet {
            refreshUI()
        }
    }
